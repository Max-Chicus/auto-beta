function Footer() {
  ...
  return (
    <footer id="footer" className="bg-gradient-to-br from-gray-950 via-gray-900 to-red-950 text-white">
      {/* Main Footer Content - fără hartă aici */}
      ...
      {/* Hartă full-width - dedesubtul tuturor */}
      <div className="w-full mt-8 border-t border-gray-800">
        ...
        {/* Link către Google Maps - suprapus sau dedesubt */}
        <div className="text-center py-3 bg-gray-900/50">
          <a
            href="https://maps.app.goo.gl/EzSENraGTnT1PG2z5"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-sm text-gray-400 hover:text-red-400 transition-colors"
          >
            📍 Deschide în Google Maps pentru direcții de navigare →
          </a>
        </div>
      </div>
    </footer>
