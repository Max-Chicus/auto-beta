...
function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Politica de Confidențialitate | Derstronik</title>
        <meta name="description" content="Politica de confidențialitate a site-ului Derstronik. Informații despre colectarea și protecția datelor personale." />
