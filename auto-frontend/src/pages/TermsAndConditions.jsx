...
function TermsAndConditions() {
  return (
    <>
      <Helmet>
        <title>Termeni și Condiții | Derstronik</title>
        <meta name="description" content="Termenii și condițiile de utilizare a site-ului Derstronik și a serviciilor oferite." />
